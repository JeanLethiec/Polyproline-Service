...
if formulaire.getvalue('list_file') == None or formulaire.getvalue('pseudo') == None or formulaire.getvalue('password') == None:
    print '''
    <form action="insert.py" method="get" role="form">
    ...
    if data[0] != 1:
        ...
        pdb_list_file = "../data/" + str(formulaire.getvalue('list_file'))
        ...
        for element in pdb_list:
            new_structure = assign_pdb(element["id"], element["chain"])
